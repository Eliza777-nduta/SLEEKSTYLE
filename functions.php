...
<html>
	...
	<body>
        <header>
            ...
            <div>
            <img src="imgs/Sleekstylelogo.jpg" style="width:150px ; height: 100px; margin-left: 5px">
            </div>
                <h1>
        Sleek Style Ladies Aparrel Store
                 </h1>
                <nav>
                ...
                <a style="position: absolute; right:30px; top: 50px;" $link>Hi $username </a>
            </div>
        </header>
        <main>
EOT;
